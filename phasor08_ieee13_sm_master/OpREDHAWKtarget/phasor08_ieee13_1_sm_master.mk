...
MODEL           = phasor08_ieee13_1_sm_master
MODULES         = rt_matrx.c rt_printf.c rt_logging.c phasor08_ieee13_1_sm_master_data.c phasor08_ieee13_1_sm_master_offsets.c rtGetInf.c rtGetNaN.c rt_nonfinite.c OP_SEND.c OpIRTS.c RECV_Param.c
MAKEFILE        = phasor08_ieee13_1_sm_master.mk
...
NCSTATES        = 0
COMPUTER        = PCWIN64
BUILDARGS       =  EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 INCLUDE_MDL_TERMINATE_FCN=1 OPTS="-DTID01EQ=1"
MULTITASKING    = 0
MAT_FILE        = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = phasor08_ieee13_1_sm_master_ref.rsp
